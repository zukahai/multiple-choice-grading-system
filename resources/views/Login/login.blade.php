    ...
    <body data-new-gr-c-s-check-loaded="14.1079.0" data-gr-ext-installed="">
        <form method="post" action="">
                    ...
                    <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <g class="body">
                            ...
                            <path class="bodyBGnormal" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                ...
                                data-original="M200,158.5c0-20.2-14.8-36.5-35-36.5h-14.9V72.8c0-27.4-21.7-50.4-49.1-50.8c-28-0.5-50.9,22.1-50.9,50v50 H35.8C16,122,0,138,0,157.8L0,213h200L200,158.5z">
                            </path>
                            <path fill="#DDF1FA"
                        ...
                        <g class="earL">
                            <g class="outerEar" fill="#ddf1fa" stroke="#3a5e77" stroke-width="2.5"
                                data-svg-origin="35.5 71.5" transform="matrix(1,0,0,1,0,0)">
                                <circle cx="47" cy="83" r="11.5"></circle>
                                <path d="M46.3 78.9c-2.3 0-4.1 1.9-4.1 4.1 0 2.3 1.9 4.1 4.1 4.1" stroke-linecap="round"
                                    stroke-linejoin="round"></path>
                            </g>
                            <g class="earHair" data-svg-origin="42.79999923706055 62.79999923706055"
                        ...
                        <g class="earR">
                            <g class="outerEar" data-svg-origin="141.5 71.5" transform="matrix(1,0,0,1,0,0)">
                                ...
                                <path fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                    ...
                                    d="M153.7,78.9 c2.3,0,4.1,1.9,4.1,4.1c0,2.3-1.9,4.1-4.1,4.1"></path>
                            </g>
                        ...
                        <path class="chin"
                            ...
                            stroke-linejoin="round" data-svg-origin="84.0999984741211 121.5999984741211"
                            transform="matrix(1,0,0,1,0,0)"></path>
                        <path class="face" fill="#DDF1FA"
                            d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46"
                            data-svg-origin="100 46" transform="matrix(1,0,0,1,0,0)"
                        ...
                        <path class="hair" fill="#FFFFFF" stroke="#3A5E77" stroke-width="2.5"
                            ...
                            data-svg-origin="104.51250076293945 27.929000854492188" transform="matrix(1,0,0,1,0,0)"
                            style="transform-origin: 0px 0px 0px;"></path>
                        <g class="eyebrow" data-svg-origin="100.85150527954102 43.33300018310547"
                            transform="matrix(1,0,0,1,0,0)" style="transform-origin: 0px 0px 0px;">
                            <path fill="#FFFFFF"
                        ...
                        <g class="eyeL" data-svg-origin="85.5 78.5"
                            transform="matrix(0.65,0,0,0.65,29.847614999999998,27.397615000000002)"
                            style="transform-origin: 0px 0px 0px;">
                            <circle cx="85.5" cy="78.5" r="3.5" fill="#3a5e77"></circle>
                            <circle cx="84" cy="76" r="1" fill="#fff"></circle>
                        </g>
                        <g class="eyeR" data-svg-origin="114.5 78.5"
                            transform="matrix(0.65,0,0,0.65,39.997615,27.397615000000002)"
                            style="transform-origin: 0px 0px 0px;">
                            <circle cx="114.5" cy="78.5" r="3.5" fill="#3a5e77"></circle>
                            <circle cx="113" cy="76" r="1" fill="#fff"></circle>
                        </g>
                        <g class="mouth" data-svg-origin="100 103.4000015258789" transform="matrix(1,0,0,1,0,0)"
                            style="transform-origin: 0px 0px 0px;">
                            <path class="mouthBG" fill="#617E92"
                                ...
                                data-original="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z">
                            </path>
                            ...
                            <path clip-path="url(#mouthMask)" class="tooth" style="fill:#FFFFFF;"
                                ...
                                data-svg-origin="100 93" transform="matrix(1,0,0,1,3,-2)"></path>
                        ...
                        <path class="nose"
                            ...
                            fill="#3a5e77" data-svg-origin="100.0374870300293 83.88750076293945"
                            transform="matrix(0.99984,-0.01777,0.01777,0.99984,-1.4750883130837593,1.7911631908879144)"
                            style="transform-origin: 0px 0px 0px;"></path>
                        <g class="arms" clip-path="url(#armMask)">
                            <g class="armL" style="visibility: hidden; transform-origin: 0px 0px 0px;"
                                ...
                                <g class="twoFingers" data-svg-origin="158.3000030517578 86.80000305175781"
                                    transform="matrix(0.86602,0.49999,-0.49999,0.86602,55.60818051566028,-69.52100616551013)"
                                    style="transform-origin: 0px 0px 0px;">
                                    <path fill="#DDF1FA" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-miterlimit="10"
                            ...
                            <g class="armR" style="visibility: hidden; transform-origin: 0px 0px 0px;"
            ...
            <div class="inputGroup inputGroup1 focusWithText">
                ...
                <input type="text" id="loginEmail" maxlength="254" class=" is-invalid " name="username"
                    value="" required="">
