        ...
        <thead>
            @if (!$exams->isEmpty())
                <tr>
                    ...
                    <th class="text-center" scope="col">Time start</th>
                    <th class="text-center" scope="col">Time end</th>
            ...
            @forelse ($exams as $item)
                <tr class="align-middle">
                    ...
                    <td class="align-center justify-content-center">
                        ...
                        <a href="{{ route('teacher.exam.showEdit') }}/{{ $item->id }}"
